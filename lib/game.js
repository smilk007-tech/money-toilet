...
export function initGame() {
  ...
  function buildReceiptCanvas() {
    ...
    function paint(ctx) {
      let y = 14; // 상단 톱니 여백
      y += 30;
      text(ctx, "돈버는 화장실", W / 2, y, font(26, "800"), INK, "center");
      y += 22;
      text(ctx, "급 여 명 세 서", W / 2, y, font(13, "700"), SUB, "center");
      y += 12;
      dash(ctx, y);
      y += 22;
      ...
      solid(ctx, y, 1.6, INK);
      y += 26;
      text(ctx, `총 ${flushes}회 물내림 실수령액`, PAD, y, font(14, "800"), INK);
      text(ctx, f(hero), W - PAD, y, font(28, "800"), INK, "right");
      y += 14;
      dash(ctx, y);
      y += 28;
