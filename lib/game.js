...
export function initGame() {
  ...
  function renderTotal(flash) {
    ...
    if (flash) {
      el.totalEarned.classList.remove("flash");
      void el.totalEarned.offsetWidth;
      el.totalEarned.classList.add("flash");
    }
  }
  ...
  async function shareReceipt() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({ title: "똥탐 영수증", text, url });
        return;
      } catch (e) {
