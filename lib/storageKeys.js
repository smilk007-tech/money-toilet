...
export const LS = {
  ...
  flushLifetime: "mt_flush_lifetime", // 최초 접속 이후 누적 물내림 횟수(기록 초기화와 무관) — 급여명세서 버튼 최초 노출 판정용
  ...
  todayDwell: "mt_today_dwell", // 오늘(KST) 누적 {d:"YYYY-MM-DD",s:체류초,f:물내림횟수} — 루팡 티어 산정용, 자정 리셋
  tierSnap: "mt_tier_snap", // 최근 물내림 시점 티어 스냅샷 {d,p,prevP} — 명세서 도장/델타용
  devToolsUnlocked: "mt_dev_tools_unlocked", // 형광등 30탭 이스터에그로 개발자 도구 노출
  nickDiceShown: "mt_nick_dice_shown", // 설정 패널 주사위 넛지 1회 완료
};
