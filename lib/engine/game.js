...
export function initGame() {
  ...
  async function showDonateToast() {
    try { await navigator.clipboard.writeText("https://moneytoilet.kr"); } catch {}
    toast("공유하기가 곧 후원!<br>moneytoilet.kr 복사완료", true);
  }
  ...
  el.adA4.addEventListener("click", (e) => {
    ...
    if (currentAdCreative.brand) { doSiteShare(); return; }
